...
$url64      = 'https://github.com/wereturtle/ghostwriter/releases/download/2.1.6/ghostwriter_2.1.6_win64_portable.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'ghostwriter-portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
